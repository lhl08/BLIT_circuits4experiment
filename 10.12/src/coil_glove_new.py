...
class CoilMaker:
    ...
    def makeCoil(self, path, transmission_line_length, integrated_r = False, integrated_c = False, reverse = False):
        ...
        path.L(-65, centers[1] - spacing[1])
        path.L(-65, -30)
        print("???", centers[1] - spacing[1])
        # path.L(0, -76)
        path.L(0, -30)
        path.L(10,-30)
        path.L(10,-40)
...
if __name__=="__main__":
    CoilMaker.GenerateCoil("coil_glove_new", 2, 30, 25,reverse= True, intergrated_c= False, intergrated_r=False)
