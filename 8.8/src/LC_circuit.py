...
class CoilMaker:
    ...
    def makeCoil(self, path, transmission_line_length, integrated_r = False, integrated_c = False, reverse = False, Left = True):
...
if __name__=="__main__":
    CoilMaker.GenerateCoil("LC_circuit", 2, 2.3, 10,reverse= False, intergrated_c= False, intergrated_r=False)
