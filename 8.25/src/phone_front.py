...
class CoilMaker:
    ...
    def makeCoil(self, path, transmission_line_length, integrated_r = False, integrated_c = False, reverse = False):
        ...
        path.M(95, -120)
        coil_location = array([(transmission_line_length)*reverseF*PIXEL_SCALE, -120])
...
if __name__=="__main__":
    CoilMaker.GenerateCoil("phone_front", 2, 30, 25,reverse= True, intergrated_c= False, intergrated_r=False)
