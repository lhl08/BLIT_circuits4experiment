...
class CoilMaker:
    ...
    def makeCoil(self, path, transmission_line_length, integrated_r = False, integrated_c = False, reverse = False):
        ...
        path.L(-100, centers[1] - spacing[1])
        path.L(-100, centers[1] - spacing[1] - 12)
        path.L(-100, centers[1] - spacing[1] - 22)
        path.L(-90, centers[1] - spacing[1] - 22)
        path.L(-90, centers[1] - spacing[1] - 12)
        path.L(-100, centers[1] - spacing[1] - 12)
...
if __name__=="__main__":
    CoilMaker.GenerateCoil("MiddleCoil", 2, 30, 25,reverse= True, intergrated_c= False, intergrated_r=False)
